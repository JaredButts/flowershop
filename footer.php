...
?>
    <div id="footer">
        ...
        <p id="copyright" class="reset pull_out padding" role="contentinfo"><a href=" ">© <?php echo $copyright; ?> Hansel and Petal</a></p>
        <p id="disclaimer">Hansel &amp; Petal is a fictitious brand created by 
             solely for the purpose of training. All products and people 
